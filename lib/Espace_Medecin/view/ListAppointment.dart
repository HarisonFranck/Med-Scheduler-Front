...
class _ListAppointmentState extends State<ListAppointment> {
  ...
  void didChangeDependencies() {
    ...
    listRdvJJ =
        filterToday(medecinRepository!.getAllAppointmentByMedecin(user!));
    listRdvNext =
        filterNext(medecinRepository!.getAllAppointmentByMedecin(user!));
    listRdvFinished =
        filterFinished(medecinRepository!.getAllAppointmentByMedecin(user!));
  }
