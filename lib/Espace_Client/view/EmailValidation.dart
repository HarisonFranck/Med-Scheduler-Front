...
class _EmailValidationState extends State<EmailValidation> {
            ...
            children: [
              ...
              const Padding(padding: EdgeInsets.only(top:40,bottom: 80,left: 40,right: 40),child: Center(
                ...
                child: Card(
                  color: Colors.transparent,
                  elevation: 0,
                  child: Text('Veuillez saisir l\'e-mail associé à votre compte Med Scheduler dans le champ ci-dessous. Assurez-vous d\'utiliser l\'adresse e-mail utilisée lors de votre inscription.',textAlign: TextAlign.center,style: TextStyle(color: Color.fromARGB(1000, 60, 70, 120),letterSpacing: 1.3),) ,
                ),
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: false,child:isLoading?scafWithLoading():Scaffold(
